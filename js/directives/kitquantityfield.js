four51.app.directive('kitquantityfield', ['$451', 'KitProductDisplayService', function($451, KitProductDisplayService){
	var obj = {
		scope: {
			lineitem : '=',
			calculated: '=',
		...
		template: '<div ng-if="lineitem.ID">'+
			...
			scope.qtyChanged = function(lineitem){
				KitProductDisplayService.calculateLineTotal(lineitem);
				if(scope.calculated)
